  ...
  render() {
    return (
      <div className="wizthreeshelter-body">
        <div className="wizthreeshelter-boxcolor">
          <div className="navbar">
            <NavBarShelter />
          </div>
          <div className="wizthreeshelter-textbox">
            <div className="wizthreeshelter-title">
              <h1>Getting To Know You</h1>
            </div>
            <div className="wizthreeshelter-form">
              <Form>
                <FormGroup row>
                ...
                <div className="wizthreeshelter-button">
