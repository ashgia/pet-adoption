...
class WizardThree extends Component {
  render() {
    ...
    return (
      <div className="wizardthree-body">
        <div className="wizardthree-boxcolor">
          <div className="navbar">
            <NavBarSide />
          </div>
          <div className="wizardthree-textbox">
            <div className="wizardthree-title">
              <p>What Are You Interested In Adopting?</p>
            </div>
            <div className="wizardthree-form">
              <Form>
                <FormGroup row>
            ...
            <div className="wizardthree-button">
              <Link to="/wizardFour">
                <Button
